<template>
  <div class="bg-[#faf7f1] text-center py-10 space-y-10 ">
    ...
    <!-- Principal Sponsors -->
    <div class="space-y-6 x-8">
      <div class="border border-black inline-block w-[220px] py-2 font-futuraRegular uppercase">Principal Sponsors</div>
    ...
    <!-- Guests -->
    <div class="space-y-6">
      <div class="border border-black inline-block w-[220px] py-2 font-futuraRegular uppercase">Guests</div>
      ...
      <div class="flex justify-center gap-12">
        ...
        <div class="text-xs uppercase">
          <p>Ladies</p>
          <p class="text-[8px]">Beautiful<br />Semi-formal / Formal attire</p>
        </div>

        <!-- Gentlemen -->
        <div class="  text-xs uppercase">
          <p>Gentlemen</p>
          <p class="text-[8px] ">Stunning<br />Semi-formal / Formal attire</p>
        </div>
      </div>
    </div>
